...
#Also keeps number of characters constant by default (only applies to numeric SubIDs) 
#and removes SubID by default
{
  TheRowNames = Data[,SubID]
  
  #If numeric SubID, check on what to do about length
  if(is.numeric(TheRowNames))
  {
