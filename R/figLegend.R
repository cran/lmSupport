figLegend <- function(x, y=NULL, legend, fill=NULL, angle=NULL, density=NULL, pch=NULL, leg.cex=NULL, 
  ...
  #our lab's default figure parameters 
{
  ...
  legend(x=x,y=y,legend=legend, fill=fill, angle=angle, density=density, pch=pch, 
         box.lwd=leg.lwd, pt.lwd=leg.lwd, cex=leg.cex, text.font=leg.font, bty=leg.bty)
